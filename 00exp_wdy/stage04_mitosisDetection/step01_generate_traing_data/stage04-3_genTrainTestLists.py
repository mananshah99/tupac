...
TRAIN_OUT = '/data/dywang/Database/Proliferation/libs/stage04_mitosisDetection/training_examples/train.lst'
VAL_OUT   = '/data/dywang/Database/Proliferation/libs/stage04_mitosisDetection/training_examples/val.lst'
...
negfiles = [l.strip() for l in os.popen('find /data/dywang/Database/Proliferation/libs/stage04_mitosisDetection/training_examples/neg -name "*.png"').readlines()]
