...
model_weights = 'models.final/mitosis_detection_wo_norm.caffemodel' #/cnn10_iter_227000.caffemodel'
...
for line in f:
    ...
    plt.imsave('../mitko-pos_result_maps/' + sample_image_name + '_class=' + str(sample_image_output) + '.png', im)
    bar.update(1)
bar.close()
