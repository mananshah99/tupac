...
from utils import load_pickle_data_cv, batch_iterator_valid, batch_iterator_train_crop_flip, load_pickle_data_tupac
...
train_X, test_X, train_y, test_y = load_pickle_data_tupac()
